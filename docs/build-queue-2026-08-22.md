...
| NBA | `docs/multi-sport-expansion-audit-2026-08-22.md` §2 | **Building next — approved 2026-08-22.** Real, current, rich data confirmed (`sportsdataverse-data`: play-by-play, box scores, schedules, standings, rosters, season stats). Props-backend coverage confirmed via both providers' public docs. | One trivial single-call sport-key-string check at build time (Propline/ParlayAPI keys were at their live daily caps when checked) |
