...
| NHL | `docs/multi-sport-expansion-audit-2026-08-22.md` §3 | **Building next — approved 2026-08-22.** Strongest of the four — NHL's own official API (`api-web.nhle.com`) confirmed live and rich, MLB-Stats-API-equivalent tier, no third party needed for core data. Props-backend confirmed same as NBA. | Same trivial sport-key check as NBA |
