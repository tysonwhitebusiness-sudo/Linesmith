...
**Status (2026-09-20):** decisions LOCKED by the operator. **U0 and U1 are
DONE** — Tailwind 4, the token bridge, `cx` on tailwind-merge, `RouterProvider`,
the kit page, and the Button family with 73 of 96 in-scope raw buttons moved
onto it. Next: U2 (the Hybrid table).
