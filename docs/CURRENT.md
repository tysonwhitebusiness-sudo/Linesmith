...
**Third track, DECISIONS LOCKED 2026-09-19: UI system overhaul (U0–U8).**
`docs/design/ui-system-master-prompt.md` is both the spec and the resume prompt.
It sets one component per job across every page: Untitled UI's free set
