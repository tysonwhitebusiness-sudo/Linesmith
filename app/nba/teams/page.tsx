...
/** `/nba/teams` — NBA's Teams tab landing page, same shell as `/cfb/teams`. */
export default function NbaTeamsIndexPage() {
    ...
    <div className="min-h-screen pb-10">
      <header className="sticky top-0 z-20 border-b border-line bg-paper/95 backdrop-blur">
        <TopBar
          sport={sport}
          tab="Teams"
          onTabChange={(t) => router.push(t === 'Players' ? '/nba?tab=Players' : '/nba')}
