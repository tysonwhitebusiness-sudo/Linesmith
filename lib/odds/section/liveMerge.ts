...
export function mergeLiveGame(full: GameOddsPayload, live: GameOddsPayload): GameOddsPayload {
  ...
  // Edges (P11) come whole from the newest read, absent when hidden: the kill switch applies at once.
  return { ...full, asOf: live.asOf, markets: out, money: live.money ?? full.money, edges: live.edges, edgeView: live.edgeView ?? full.edgeView };
}
