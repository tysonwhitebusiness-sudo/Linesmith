...
P3 M7 (the golf hole model double-counted the subject golfer's own scores) is
closed the same way: master plan Phase 8 (2026-09-13) deleted the golf model
layer outright, `predict/golf_models.py` with it.
