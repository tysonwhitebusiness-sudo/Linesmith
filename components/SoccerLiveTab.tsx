    ...
    <div>
      ...
      {data.awayHalfScores.length > 0 ? (
        <div className="flex items-center justify-between px-[26px] py-3" style={{ borderBottom: `1px solid ${C.divider}` }}>
          <div className="text-label tracking-[.12em]" style={{ color: C.faintMono }}>BY HALF</div>
      ...
      <div className="px-[26px] py-3" style={{ borderBottom: `1px solid ${C.divider}` }}>
        <div className="mb-1 text-label tracking-[.1em]" style={{ color: C.faintMono }}>MATCH EVENTS</div>
        {notableEvents.length === 0 ? (
          <p className="py-1 text-label" style={{ color: C.faintMono }}>No goals, cards, or substitutions yet.</p>
        ) : (
