...
export function TournamentLinesView({
  ...
  return (
    <div className="space-y-2">
      ...
      {eventName ? <p className="px-1 text-overline font-normal tracking-normal text-ink-muted">{eventName} · Match Winner</p> : null}
          ...
          const row = (
            <div className="flex items-center gap-3 px-3 py-2">
              ...
              <div className="min-w-0 flex-1">
                <div className="truncate text-body-sm font-medium text-ink">{line.golferName}</div>
                <div className="flex items-center gap-1.5 text-overline font-normal tracking-normal text-ink-muted">
